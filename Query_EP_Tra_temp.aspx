<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Query_EP_Tra_temp.aspx.cs" Inherits="Query_npiEATra" %>
...
<body>
        ...
        <div class="left">
         ...
         <div >
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" 
               ...
               DataKeyNames="Ver_Name,Ver_No"   onrowcommand="GridView1_RowCommand"  PageSize="7" AllowSorting="True" >
                <HeaderStyle Height="50px" ></HeaderStyle>
                <Columns>
                    <asp:ButtonField CommandName="search" Text="查詢"  />
                    <asp:BoundField DataField="Ver_Name" HeaderText="Ver_Name" />
                    <asp:BoundField DataField="UpdateTime" HeaderText="UpdateTime" />
                    <asp:BoundField DataField="UserName" HeaderText="UserName" />
                    <asp:BoundField DataField="Ver_Status" HeaderText="Ver_Status" />
                    <asp:BoundField DataField="Ver_POR_Customer" HeaderText="Ver_POR_Customer" />
                    <asp:BoundField DataField="Ver_POR_Device" HeaderText="Ver_POR_Device" />
                    <asp:BoundField DataField="Ver_POR_Site" HeaderText="Ver_POR_Site" />
                    <asp:BoundField DataField="Ver_POR_PKG" HeaderText="Ver_POR_PKG" />
                    <asp:BoundField DataField="Ver_POR_WT" HeaderText="Ver_POR_WT" />
                    <asp:BoundField DataField="Ver_POR_FAB" HeaderText="Ver_POR_FAB" />
                    <asp:BoundField DataField="Ver_POR_PSV" HeaderText="Ver_POR_PSV" />
                    <asp:BoundField DataField="Ver_POR_RVSI" HeaderText="Ver_POR_RVSI" />
                    <asp:BoundField DataField="Ver_New_Customer" HeaderText="Ver_New_Customer" />
                    <asp:BoundField DataField="Ver_New_Device" HeaderText="Ver_New_Device" />
                </Columns>
 ...
 collapse;width:900pt">
            ...
            <tr class="style-td-white">
                <td class="auto-style345">2</td>
                <td class="auto-style346"  colspan="2">Device<span style="mso-spacerun:yes">&nbsp;</span></td>
                <td>-</td>
                <td  >
